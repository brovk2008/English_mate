// app/(student)/games/word-blitz/page.tsx
import { redirect } from 'next/navigation';
import { createClient } from '@/lib/supabase/server';
import WordBlitzClient from './WordBlitzClient';

export const dynamic = 'force-dynamic';

export default async function WordBlitzPage() {
  ...
  return (
    <WordBlitzClient initialWords={gameWords} />
  );
}
